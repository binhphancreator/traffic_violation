...
<body>
    ...
    <nav class="container-lg mb-2" aria-label="breadcrumb">
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active" aria-current="page"><a>Cập nhật tài liệu</a></li>
        </ol>
    </nav>
    ...
    <section class="main-content container-lg mb-5">
        ...
        <form enctype="multipart/form-data" action="/document/update" method="POST">
            <div class="p-3 py-4 shadow-sm rounded-3">
                <div class="row mb-4">
                    <input type="hidden" value="<?php echo $document->id ?>" require name="id">
                    <div class="col-12 mb-4">
                        <label for="nameInput" class="form-label">Tên tài liệu</label>
                        <input value="<?php echo $document->name ?>" require type="text" class="form-control" id="nameInput" name="name">
                    </div>
                    <div class="col-12 mb-4">
                    ...
                    <div class="col-12 mb-4">
                        ...
                        <textarea value="<?php echo $document->description ?>" class="form-control resize-none" class="form-control" id="descriptionInput" name="description" rows="3"></textarea>
                    </div>
                </div>
                <?php if(session()->old('error')) { $error = session()->old('error'); echo "<div class=\"alert-danger p-2 mb-4\">$error</div>";}  ?>
                <div class="d-flex justify-content-center">
                    <button type="submit" class="btn-rounded-left p-2" href="/lookup-violation.html">Cập nhật</button>
                </div>
            </div>
        </form>
    </section>
